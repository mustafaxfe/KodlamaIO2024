    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Product> products = new List<Product>
            {
                ...
                new Product{ProductId =5, CategoryId=2, ProductName = "Apple Telefon", QuantityPerUnit = "4 GB Ram", UnitPrice = 0000, UnitsInStock = 0 },
            };
        ...
        static List<Product> GetProductsLinq(List<Product> products)
        {
            ...
            return (List<Product>)products.Where(p => p.UnitPrice > 5000 && p.UnitsInStock > 3);
        }
    }
    class Product
    {
